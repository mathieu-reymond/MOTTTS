#ifndef AI_TOOLBOX_BANDIT_MO_THOMPSON_SAMPLING_POLICY_HEADER_FILE
#define AI_TOOLBOX_BANDIT_MO_THOMPSON_SAMPLING_POLICY_HEADER_FILE
...
namespace AIToolbox::Bandit {
     ...
     * respective arm.
     */
    class MOThompsonSamplingPolicy : public PolicyInterface {
        public:
            /**
             ...
             */
            MOThompsonSamplingPolicy(const MOExperience & exp, const Vector & weights);
