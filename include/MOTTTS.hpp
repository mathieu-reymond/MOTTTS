#ifndef AI_TOOLBOX_BANDIT_MO_TOP_TWO_THOMPSON_SAMPLING_POLICY_HEADER_FILE
#define AI_TOOLBOX_BANDIT_MO_TOP_TWO_THOMPSON_SAMPLING_POLICY_HEADER_FILE
...
namespace AIToolbox::Bandit {
     ...
     */
    class MOTopTwoThompsonSamplingPolicy : public PolicyInterface {
        public:
            /**
             * @brief Basic constructor.
             *
             * @param exp The Experience we learn from.
             * @param weights The utility function weights.
             * @param beta The probability of playing the first sampled best action instead of the second sampled best.
             */
            MOTopTwoThompsonSamplingPolicy(const MOExperience & exp, const Vector & weights, double beta);
             ...
             */
            const MOExperience & getExperience() const;
            const Vector & getWeights() const;

        private:
            MOThompsonSamplingPolicy policy_;
            double beta_;
    };
}
